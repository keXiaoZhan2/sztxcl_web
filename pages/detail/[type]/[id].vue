    ...
    <LoadingGroup :pending="pending" :error="error">
        ...
        <n-grid :x-gap="20">
            <n-grid-item :span="24">
                ...
                <section class="detail-bottom min-h-100" >
                    ...
                    <div v-if="tab == 'content'" class="content" v-html="data.isbuy ? data.desc : data.try">
                    </div>
...
<script setup>
    ...
    // 菜单
    const menus = computed(()=> (type == 'book' ? data.value.book_detail : data.value.column_courses ) || [])
